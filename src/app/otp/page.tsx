// src/pages/otp-verification.tsx
...
const OTPVerification: React.FC = () => {
  ...
  // const email = sessionStorage.getItem('email')|| 'your email';
  ...
  const handleVerify =async () => {
    ...
    // Call your backend API to verify OTP here
  };
  ...
  return (
      ...
      <div className="flex justify-center items-center h-screen bg-gray-100">
        <div className="bg-white p-8 rounded-lg shadow-md w-full max-w-md">
          ...
          <p className="text-center mb-6">Enter the 8-digit code you have received on {email.replace(/(.{2}).*?(@.*)/, '$1***$2')}</p>
